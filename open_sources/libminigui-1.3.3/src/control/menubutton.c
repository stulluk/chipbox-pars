/*
** $Id: menubutton.c,v 1.26 2003/09/04 02:40:36 weiym Exp $
**
...
static int MenuButtonCtrlProc (HWND hWnd, int message, WPARAM wParam, LPARAM lParam)
{
    ...
    case MSG_PAINT:
    {
        ...
        hdc = BeginPaint (hWnd);
        Draw3DControlFrame (hdc, rcClient.left, rcClient.top,
...
#ifdef _FLAT_WINDOW_STYLE
        DrawFlatControlFrameEx (hdc, rcMenuBar.left, rcMenuBar.top, 
                    rcMenuBar.right, rcMenuBar.bottom, bk_color, 0, 0);
#else
        Draw3DUpThinFrame (hdc, rcMenuBar.left, rcMenuBar.top, 
                    rcMenuBar.right, rcMenuBar.bottom, bk_color);
#endif
        EndPaint (hWnd, hdc);
        return 0;
    }
