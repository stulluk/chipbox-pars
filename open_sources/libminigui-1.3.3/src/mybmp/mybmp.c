...
NULL, check_bmp },
   ...
   { "lbm", load_lbm, NULL, check_lbm },
#else
   { "",    NULL,     NULL, NULL },
#endif
#ifdef _PCX_FILE_SUPPORT
   { "pcx", load_pcx, NULL, NULL },
#else
   { "",    NULL,     NULL, NULL },
#endif
#ifdef _TGA_FILE_SUPPORT
   { "tga", load_tga, NULL, NULL },
#else
   { "",    NULL,     NULL, NULL },
#endif
#ifdef _GIF_FILE_SUPPORT
   { "gif", load_gif, NULL, check_gif },
#else
   { "",    NULL,     NULL, NULL },
#endif
#ifdef _JPG_FILE_SUPPORT
   { "jpg", load_jpg, NULL, check_jpg },
#else
   { "",    NULL,     NULL, NULL },
#endif
#ifdef _PNG_FILE_SUPPORT
   { "png", load_png, NULL, check_png },
#else
   { "",    NULL,     NULL     },
#endif
   { "",    NULL,     NULL     },
