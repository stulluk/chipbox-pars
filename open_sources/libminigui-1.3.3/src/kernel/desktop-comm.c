...
// FIXME #ifndef _LITE_VERSION
// FIXME     CustomizeDesktopMenu (hDesktopMenu, 5);
// FIXME #endif
}
...
// FIXME #ifndef _LITE_VERSION
// FIXME         else
// FIXME             return CustomDesktopCommand ((int)wParam);
// FIXME #endif
    }
    ...
    switch (message) {
       ...
       break;
        ...
        case MSG_ERASEDESKTOP:
            SetBrushColor (hDesktopDC, 0x00000000/*GetWindowElementColor (BKC_DESKTOP)*/);
