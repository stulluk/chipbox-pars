...
void musb_sleep(unsigned int loopi)
{
	unsigned int loopk;	
...
// FIXME 	usb_get_descriptor2();
// FIXME         
// FIXME         tmp = MGC_Read8(BASE_ADDR, 0x60);
// FIXME         tmp &= 0xfE;
// FIXME         printf("Write value to address 0x60 value=%02x  \n",tmp);
// FIXME         printf("Clear Session Bit \n");
// FIXME         MGC_Write8(BASE_ADDR, 0x60, tmp);

	return;
}

int do_usbtest_md (void)
{
