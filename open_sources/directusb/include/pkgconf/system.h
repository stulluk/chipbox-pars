...
#define CYGPKG_HAL_ARM_ARM9_ARM926T 1
#define CYGPKG_HAL_ARM_ARM9_ORION current
#define CYGPKG_HAL_ARM_ARM9_ORION_current
#define CYGNUM_HAL_ARM_ARM9_ORION_VERSION_MAJOR CYGNUM_VERSION_CURRENT
#define CYGNUM_HAL_ARM_ARM9_ORION_VERSION_MINOR -1
#define CYGNUM_HAL_ARM_ARM9_ORION_VERSION_RELEASE -1
#define CYGBLD_HAL_TARGET_H   <pkgconf/hal_arm.h>
#define CYGBLD_HAL_VARIANT_H  <pkgconf/hal_arm_arm9.h>
#define CYGBLD_HAL_PLATFORM_H <pkgconf/hal_arm_arm9_orion.h>
#define CYG_HAL_STARTUP RAM
#define CYG_HAL_STARTUP_RAM
#define CYGHWR_MEMORY_LAYOUT_LDI <pkgconf/mlt_arm_arm9_orion_ram.ldi>
#define CYGHWR_MEMORY_LAYOUT_H <pkgconf/mlt_arm_arm9_orion_ram.h>
