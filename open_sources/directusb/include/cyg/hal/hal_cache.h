...
#elif defined(CYGPKG_HAL_ARM_ARM9_ARM926T)
# define HAL_ICACHE_SIZE                 0x2000
# define HAL_ICACHE_LINE_SIZE            32
...
//# define CYGHWR_HAL_ARM_ARM9_CLEAN_DCACHE 	// Use Compatible way to Clean Cache for safety
# define CYGHWR_HAL_ARM_ARM9_CLEAN_DCACHE_926EJS

#if 0	// DXL:  uncomment after got the paramter for ARM 926EJ-S
# define CYGHWR_HAL_ARM_ARM9_CLEAN_DCACHE_INDEX // has instruction to clean D-cache
# define CYGHWR_HAL_ARM_ARM9_CLEAN_DCACHE_INDEX_STEP 	
# define CYGHWR_HAL_ARM_ARM9_CLEAN_DCACHE_INDEX_LIMIT	
#endif
...
CYG_MACRO_START                                                         \
    asm volatile (                                                      \
        ...
        "mcr  p15,0,r1,c1,c0,0;"                                         		\
		"mov r1, #4;"														\
		"mcr     p15, 7, r0, c15, c0, 0;"	/*Writethrough D-Cache*/						\
        :                                                               \
        :                                                               \
        : "r1" /* Clobber list */                                       		\
        );                                                              \
...
CYG_MACRO_END
#elif defined CYGHWR_HAL_ARM_ARM9_CLEAN_DCACHE_926EJS	//DXL: special code for ARM 926EJ-S
#define HAL_DCACHE_SYNC()                                               \
CYG_MACRO_START                                                         \
    asm volatile (  							\
	"1: "								\
