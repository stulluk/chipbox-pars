...
// ======== 0x800 CAN =======================================================
// Get/Set configuration 'key' values for  CAN bus drivers
#define CYG_IO_SET_CONFIG_CAN_ID                 0x800
#define CYG_IO_SET_CONFIG_CAN_MASK               0x801
#define CYG_IO_SET_CONFIG_CAN_LEN                0x802
#define CYG_IO_SET_CONFIG_CAN_EXT                0x803
#define CYG_IO_SET_CONFIG_CAN_STA                0x804
#define CYG_IO_SET_CONFIG_CAN_TX                 0x805
#define CYG_IO_SET_CONFIG_CAN_RX                 0x806

#define CYG_IO_GET_CONFIG_CAN_ID                 0x880
#define CYG_IO_GET_CONFIG_CAN_MASK               0x881
#define CYG_IO_GET_CONFIG_CAN_LEN                0x882
#define CYG_IO_GET_CONFIG_CAN_EXT                0x883
#define CYG_IO_GET_CONFIG_CAN_STA                0x884
#define CYG_IO_GET_CONFIG_CAN_TX                 0x885
#define CYG_IO_GET_CONFIG_CAN_RX                 0x886

// ======== 0x900 USB Host =======================================================
// Get/Set configuration 'key' values for  USB Host drivers
#define CYG_IO_SET_CONFIG_ENPOINTS               0x900
#define CYG_IO_SET_CONFIG_SEMAPHORE              0x901

#define CYG_IO_GET_USB_STATE                     0x980
#define CYG_IO_GET_CONFIG_DEVICE_DESC            0x981
#define CYG_IO_GET_CONFIG_CONFIGURATION_DESC     0x982
#define CYG_IO_GET_CONFIG_STRING                 0x983
#define CYG_IO_GET_CONFIG_INTERFACE              0x984
#define CYG_IO_GET_CONFIG_ENDPOINT               0x985
