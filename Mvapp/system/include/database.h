...
typedef	enum
{
	eCS_DB_Appearing_Order = 0,		/*��ͨģʽ����Ŀ������˳������*/
	eCS_DB_Operator_Defined			/*��Ŀ����Ӫ�̶���˳������*/
} tCS_DB_LCNMode;					/*LCNģʽ*/				/*��Ƶ����ģʽ*/
...
typedef	enum
{
	eCS_DBU_SCARTCVBS,	/*CVBS�ź�ѡ��*/
	eCS_DBU_SCARTRGB		/*RGB�ź�ѡ��*/
} tCS_DBU_ScartMode;
...
typedef enum
{
	...
	eCS_DBU_ARM_PANSCAN
} tCS_DBU_AspectRatioMode;		/*��Ƶ��������ʾģʽ*/

typedef	enum
{
	eCS_DBU_TIME_AUTOMATIC = 0, 	/*��TDT/TOT�ж�ȡʱ��*/
	eCS_DBU_TIME_MANUAL,			/*�û��Լ�����ʱ��*/
	eCS_DBU_TIME_INTERNET
} tCS_DBU_TimeMode;					/*ʱ������ģʽ*/

typedef struct
{
	tCS_DB_ServiceListType 	sCS_DB_ServiceListType;		/*�б�����*/
	U32						sCS_DB_ServiceListTypeValue;/*�б�����ֵ*/
} tCS_DB_ServiceListTriplet;								/*��Ŀ�б��ؼ�������*/
...
typedef struct
{
	U16 	u16DB_List_ServiceNum[MV_LIST_NUMBER];	/*�б��еĽ�Ŀ����*/
} tCS_DB_ServiceListInfo;			/*��Ŀ�б��������Ϣ*/

typedef	struct
{
	char	sCS_DBU_CheckString[4];
	U8		sCS_DBU_ScartMode;										/*SCART����źŸ�ʽ*/
	U8		sCS_DBU_SpdifStatus;									/*SPDIF���״̬*/	
	U8 		sCS_DBU_VideoOutPut;									/*��Ƶ����˿�*/
	U8 		sCS_DBU_VideoDefinition;								/*��Ƶ������*/
	U32		sCS_DBU_VideoEncodingMode;								/*��Ƶ��ʽ*/
	U32		sCS_DBU_VideoAspectRatio;								/*��Ƶ������*/
	U32		sCS_DBU_AspectRatioMode;								/*��Ƶ��������ʾģʽ*/
	U32		sCS_DBU_DefaultAudioType;								/*Ĭ����Ƶ����*/
	...
	U32		sCS_DBU_TimeOffset;										/*ʱ��ƫ��,ʱ���ʽ��31λ: 1��ʾ����0��ʾ+, ��16λ��4����4λBCD��*/
	U32		sCS_DBU_TimeMode;										/*ʱ������ģʽ*/
	U32		sCS_DBU_TimeRegion;										/*ʱ����������ֵ*/
	char	sCS_DBU_PinCode[4];										/*����*/
...
}tCS_DBU_UserSetting_Save; 	/*�û��������ݲ��֣�����32λ���룬����e2p��д*/

typedef struct
{
	tCS_DB_ServiceListTriplet 	sCS_DBU_ServiceList;				/*��Ŀ�����б���Ϣ*/
	U32          				sCS_DBU_ServiceIndex;				/*�б��иý�Ŀ������*/	
} tCS_DBU_Service;													/*��Ŀ������Ϣ�ؼ���,32λ���룬����E2P��д*/
