		...
		case MSG_KEYDOWN:
...
#endif
			{
				switch(wparam)
				{
					...
					//v37den itibaren komple degi�tirdim a�a��y�...
					...
					if (eklfile){
                        ...
                        SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                        CS_MW_TextOut(hdc, ScalerWidthPixel(500), ScalerHeigthPixel(20), "KISAYOL B�LG� EKRANI");
                        ...
                        if ( (pluginfile = fopen("/usr/work1/scplay.sh", "r")) != NULL ){
                            ...
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(60), "IPTV y�kl� de�il..");
                        }
						if ( (pluginfile = fopen("/usr/work1/scsat.sh", "r")) != NULL ){
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(60), "MA� B�LG� =======> UYDU");
                            fclose(pluginfile);
                        }
                        else{
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(60), "MA� B�LG� y�kl� de�il..");
                        }
                        ...
                        if( (pluginfile = fopen("/usr/work1/sc8.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(90), "Gazeteler y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/scf1.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(90), "Puan Durumu y�kl� de�il..");
                        }

                        if((pluginfile = fopen("/usr/work1/S70oscam", "r")) != NULL){
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(120), "OSCAM sunucular� ====> MAV�");
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(120), "OSCAM y�kl� de�il..");
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(150), "OSCAM y�kl� de�il..");
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(120), "OSCAM y�kl� de�il..");
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(150), "OSCAM y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/scred.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(180), "Haritalar y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/scf2.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(180), "FIKRA y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/sc3.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(210), "Hava Durumu y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/screc.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(210), "NFS KAYIT y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/sc1.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(240), "AutoZAP y�kl� de�il..");
                        }

                        if((pluginfile = fopen("/usr/work1/screcall.sh", "r")) != NULL){
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(240), "Yeniden Ba�lat =====> GER�");
                            fclose(pluginfile);
                        }
                        else{
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(240), "Yeniden Ba�lat y�kl� de�il..");
                        }

                        if((pluginfile = fopen("/usr/work1/sc5.sh", "r")) != NULL){
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(270), "D�viz / Alt�n =========> 5");
                            fclose(pluginfile);
                        }
                        else{
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(270), "D�viz / Alt�n y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/sc6.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(300), "Namaz Vakitleri y�kl� de�il..");
                        ...
                        if((pluginfile = fopen("/usr/work1/scepg.sh", "r")) != NULL){
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(270), "Yay�n Ak��� ==========> EPG");
                            fclose(pluginfile);
                        }
                        else{
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(270), "Yay�n Ak��� y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/scepg.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(660), ScalerHeigthPixel(300), "MailYedek y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/sc7.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(330), "InfoShow y�kl� de�il..");
                        }
                        ...
                        if((pluginfile = fopen("/usr/work1/sc0.sh", "r")) != NULL){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(360), "Turksat frekans y�kl� de�il..");
                        }
                        ...
                        /*if(pluginfile = fopen("/usr/work1/scinfo.sh", "r")){
                            ...
                            SetTextColor(hdc, MVAPP_YELLOW_COLOR_ALPHA);
                            CS_MW_TextOut(hdc, ScalerWidthPixel(120), ScalerHeigthPixel(390), "Ekl. Eklentisi y�kl� de�il..");
                        }*/
                        ...
                        SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                        CS_MW_TextOut(hdc, ScalerWidthPixel(350), ScalerHeigthPixel(490), "��kmak i�in EXIT butonuna bas�n�z");
                        EndPaint(hwnd,hdc);
                    ...
                    SetBkMode(hdc, BM_TRANSPARENT);
                    SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                    CS_MW_TextOut(hdc, ScalerWidthPixel(720), ScalerHeigthPixel(120), "Streaming ba�l�yor...");
                    EndPaint(hwnd,hdc);
						system( "/usr/work1/scff.sh" );
						/*printf("Streaming ba�l�yor...\n");
					...
					if(testoscam != NULL){
                        ...
                        SetBkMode(hdc, BM_TRANSPARENT);
                        SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                        CS_MW_TextOut(hdc, ScalerWidthPixel(720), ScalerHeigthPixel(120), "Oscam yeniden ba�lat�l�yor..");
                        EndPaint(hwnd,hdc);
                        ...
                        SetBkMode(hdc, BM_TRANSPARENT);
                        SetTextColor(hdc, MVAPP_YELLOW_COLOR);
                        CS_MW_TextOut(hdc, ScalerWidthPixel(720), ScalerHeigthPixel(120), "Oscam zaten y�kl� de�il..");
                        EndPaint(hwnd,hdc);
...
//							printf("\n MainMenu Message -- ESC\n\n");
                    ...
                    case CSAPP_KEY_PAUSE:
						...
						{
							//CFG_Factory_Mode = FALSE; //Sertac v37-test1 fabrika men�s�n� kapatma i�in...
